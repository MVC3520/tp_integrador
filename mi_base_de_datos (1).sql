...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2023 a las 23:42:57
...
ALTER TABLE `lineascompra`
  ...
  ADD UNIQUE KEY `compras_id` (`compras_id`);
...
--
ALTER TABLE `compras`
  ADD CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`clientes_dni`) REFERENCES `clientes` (`dni`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`id`) REFERENCES `lineascompra` (`compras_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
